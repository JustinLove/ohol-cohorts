playerstats <- function(lives) {
  ...
  lives$startweek <- strftime(as.POSIXct(lives$started, tz = "GMT", "1970-01-01"), format="%Y-%V")
  lives$birthweek <- strftime(as.POSIXct(lives$birthtime, tz = "GMT", "1970-01-01"), format="%Y-%V")
