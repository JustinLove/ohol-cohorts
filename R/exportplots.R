...
ggsave("output/density_days_owned.png", width = w, height = h)

ggplot(lives, aes(daysplayed)) + geom_freqpoly() + labs(y = "lives")
ggsave("output/density_days_played.png", width = w, height = h)
...
ggplot(summaryowned, aes(daysowned)) +
  ...
  geom_smooth(data=lives, aes(y=lifetime))
ggsave("output/mean_lifetime_by_days_owned.png", width = w, height = h)

ggplot(summaryowned, aes(daysowned)) +
  geom_point(data=summaryowned, aes(y=infant_death_rate)) +
  geom_smooth(data=lives, aes(y=as.numeric(lt1)))
ggsave("output/infant_death_rate_by_days_owned.png", width = w, height = h)

ggplot(summaryownedkills, aes(daysowned)) +
  geom_point(data=summaryownedkills, aes(y=mean_kills)) +
  geom_smooth(data=dangerous, aes(y=kills))
ggsave("output/mean_kills_by_days_owned.png", width = w, height = h)
...
ggplot(summaryplayed, aes(daysplayed)) +
  ...
  geom_smooth(data=lives, aes(y=lifetime))
ggsave("output/mean_lifetime_by_days_played.png", width = w, height = h)

ggplot(summaryplayed, aes(daysplayed)) +
  geom_point(data=summaryplayed, aes(y=infant_death_rate)) +
  geom_smooth(data=lives, aes(y=as.numeric(lt1)))
ggsave("output/infant_death_rate_by_days_played.png", width = w, height = h)

ggplot(summaryplayedkills, aes(daysplayed)) +
  geom_point(data=summaryplayedkills, aes(y=mean_kills)) +
  geom_smooth(data=dangerous, aes(y=kills))
ggsave("output/mean_kills_by_days_played.png", width = w, height = h)
...
ggplot(summaryownedgender,
  ...
  geom_smooth(data=lives, aes(y=lifetime)) +
  scale_color_manual(values=evegenderPalette)
ggsave("output/mean_lifetime_by_days_owned_and_gender.png", width = w, height = h)
...
ggplot(summaryownedgender,
  ...
  geom_smooth(data=lives, aes(y=as.numeric(lt1))) +
  scale_color_manual(values=evegenderPalette)
ggsave("output/infant_death_rate_by_days_owned_and_gender.png", width = w, height = h)
...
ggplot(summaryplayedgender,
  ...
  geom_smooth(data=lives, aes(y=lifetime)) +
  scale_color_manual(values=evegenderPalette)
ggsave("output/mean_lifetime_by_days_played_and_gender.png", width = w, height = h)
...
ggplot(summaryplayedgender,
  ...
  geom_smooth(data=lives, aes(y=as.numeric(lt1))) +
  scale_color_manual(values=evegenderPalette)
ggsave("output/infant_death_rate_by_days_played_and_gender.png", width = w, height = h)
